...
// Using a single component to render all icons
const Icon = ({ name, className }) => {
    const icons = {
        ...
        Leaf: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 4 13V8a2 2 0 0 1 2-2h4l2 4l-2 4h4a2 2 0 0 1 2 2v2a7 7 0 0 1-7 7z"></path><path d="M11 20A7 7 0 0 0 18 13V8a2 2 0 0 0-2-2h-4l-2 4l2 4h-4a2 2 0 0 0-2 2v2a7 7 0 0 0 7 7z"></path></svg>,
        ...
        Sparkles: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2z"></path><path d="M5 22L7 17L12 15"></path><path d="M19 2L17 7L12 9"></path></svg>,
    };
